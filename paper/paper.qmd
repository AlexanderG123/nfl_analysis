...
subtitle: "Why the Rush Game is still King in the Modern Day NFL"
...
ggplot(q4_final_data_for_modeling, aes(x = Q4_RushingYards, y = Q4_PassingYards, color = as.factor(Win))) +
  geom_point() +
  labs(title = "Fourth-Quarter Rushing vs. Passing Yards by Win/Loss",
...
ggplot(data, aes(x = Q4_RushingYards, fill = as.factor(Win))) +
  ...
  labs(title = "Density of Fourth-Quarter Rushing Yards by Win/Loss",
       x = "Fourth-Quarter Rushing Yards",
       y = "Density",
       fill = "Outcome") +
  theme_minimal()
...
ggplot(data, aes(x = Q4_PassingYards, fill = as.factor(Win))) +
  geom_density(alpha = 0.5) +
  labs(title = "Density of Fourth-Quarter Passing Yards by Win/Loss",
       x = "Fourth-Quarter Rushing Yards",
       y = "Density",
       fill = "Outcome") +
  theme_minimal()
